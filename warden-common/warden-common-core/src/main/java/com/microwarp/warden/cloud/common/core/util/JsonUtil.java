...
public class JsonUtil {
    ...
    static {
        ...
        defaultMapper.setDateFormat(defaultDateFormat);
        ...
        dateFormatMappers.put(defaultDateFormat,defaultMapper);
    }
    ...
    public static String objectToJson(Object obj, DateFormat dateFormat){
        ...
        if(null!=obj){
            try{
                text = getFromMap(dateFormat).writeValueAsString(obj);
            }
    ...
    public static <T> T jsonToObject(String json,Class<T> clazz,DateFormat dateFormat){
        ...
        if(null!=json){
            try{
                t = getFromMap(dateFormat).readValue(json,clazz);
            }catch (Exception e){
    ...
    public static <T> T jsonToObject(String json, TypeReference<T> typeReference, DateFormat dateFormat){
        ...
        if(null!=json){
            try{
                t = getFromMap(dateFormat).readValue(json,typeReference);
            }catch (Exception e){
    ...
    public static <T> T jsonToObject(String json, JavaType javaType, DateFormat dateFormat){
        ...
        if(null!=json){
            try{
                t = getFromMap(dateFormat).readValue(json,javaType);
            }catch (Exception e){
    ...
    public static <T> T jsonToObject(InputStream inputStream, Class<T> clazz, DateFormat dateFormat){
        ...
        if(null != inputStream){
            try{
                t = getFromMap(dateFormat).readValue(inputStream,clazz);
            }catch (Exception e){
    ...
    public static <T> T jsonToObject(InputStream inputStream,TypeReference<T> typeReference, DateFormat dateFormat){
        ...
        if(null != inputStream){
            try{
                t = getFromMap(dateFormat).readValue(inputStream,typeReference);
            }catch (Exception e){
                throw new RuntimeException(e);
            }
        }
    ...
    public static <T> T jsonToObject(Reader reader, Class<T> clazz, DateFormat dateFormat){
        ...
        if(null != reader){
            try{
                t = getFromMap(dateFormat).readValue(reader,clazz);
            }catch (Exception e){
                throw new RuntimeException(e);
            }
        }
    ...
    public static <T> T jsonToObject(Reader reader, TypeReference<T> typeReference, DateFormat dateFormat){
        ...
        if(null!=reader){
            try{
                t = getFromMap(dateFormat).readValue(reader,typeReference);
            }catch (Exception e){
                throw new RuntimeException(e);
            }
        }
    ...
    public static ObjectMapper getFromMap(DateFormat key){
        if(null == key){
