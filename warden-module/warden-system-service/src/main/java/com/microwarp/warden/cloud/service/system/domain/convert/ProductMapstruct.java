...
public interface ProductMapstruct {
    ...
    CreateProductDTO createProductRequestToCreateProductDTO(CreateProductRequest createProductRequest);
    UpdateProductDTO updateProductRequestToUpdateProductDTO(UpdateProductRequest updateProductRequest);
